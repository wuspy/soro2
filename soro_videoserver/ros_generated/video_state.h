...
struct MD5Sum< ::ros_generated::video_state_<ContainerAllocator> >
{
  ...
  {
    return "f66e3b2597d6fd8e96f19abe4e80bfe0";
  }

  static const char* value(const ::ros_generated::video_state_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf66e3b2597d6fd8eULL;
  static const uint64_t static_value2 = 0x96f19abe4e80bfe0ULL;
};
