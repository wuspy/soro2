...
QString NameGen::generate(int adjectiveCount)
{
    srand(QDateTime::currentMSecsSinceEpoch());
    QString name;
    for (int i = 0; i < adjectiveCount; ++i)
    {
        name += _adjectives.value(rand() % _adjectives.length());
    }
    name += _objects.value(rand() % _objects.length());
